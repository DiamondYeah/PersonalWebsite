...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleDisplayMode() {
        ...
        const icons = document.querySelectorAll(".toggle_icon, .link_icon, .normal_icon"); // Icons
        ...
        const paragraphs = document.querySelectorAll(".toggle_white, .toggle_lightblue, .toggle_darkblue"); // Paragraphs
